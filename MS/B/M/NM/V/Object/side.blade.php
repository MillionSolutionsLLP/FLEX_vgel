  ...
  <div class="panel panel-default">
   ...
   <a href="#" class="list-group-item ms-mod-btn" ms-live-link="{{ route('NM.viewNews')}}" ms-shortcut="v+n"> <i class="fa fa-eye" aria-hidden="true"></i> View All News <strong class="label label-default pull-right">V + N</strong></a>
      </div>
    </div>
  </div>
